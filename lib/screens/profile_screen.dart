...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> fetchCurrentAddress() async {
    try {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text('Address fetch nahi hua: $e')));
    } finally {
      if (mounted) {
        setState(() {
  ...
  Future<void> uploadResumeToDrive() async {
    try {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text('Resume upload nahi hua: $e')));
    } finally {
      if (mounted) {
        setState(() {
          uploadingResume = false;
  ...
  Future<void> deleteResume() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text('Resume delete nahi hua: $e')));
    }
  }
  ...
  Future<void> saveProfile() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text('Profile save nahi hua: $e')));
    } finally {
      if (mounted) {
        setState(() {
          saving = false;
  ...
  Future<void> pickProfilePhoto() async {
    try {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text('Photo select nahi hui: $e')));
    }
  }
              ...
              children: [
                Expanded(
                  child: ElevatedButton.icon(
                    ...
                    label: Text(
                      fetchingAddress ? 'Fetching...' : 'Use Current Location',
                    ),
                  ),
                ),
              ],
                        ...
                        Expanded(
                          child: OutlinedButton.icon(
                            onPressed: () async {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                  content: Text('Resume link copied'),
                                ),
                              );
                            },
